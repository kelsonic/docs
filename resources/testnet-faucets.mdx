...
2. **Get a Wallet**: [Create a wallet using Portal](../sdks/web/guide/create-a-wallet.md) and ensure you're using the desired chain.
...
And that's it! 🎉 Please reach out to our team if you run into any issues.
