...
description: "Store and manage backup shares in your own infrastructure instead of using Portal-Managed Backups."
---
...
### Why do I need webhooks for Self-Managed Backups?
...
![IMAGE: Setting up the webhook base URL.](../.gitbook/assets/image (22).png)
...
![IMAGE: Webhook configuration.](../.gitbook/assets/CleanShot 2023-04-12 at 16.39.10.png)
...
![IMAGE: A configured webhook in the Settings page of the web app.](../.gitbook/assets/image (47).png)
