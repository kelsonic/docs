...
description: "This guide will go over the basics of Portal's MPC architecture for generating, backing up, and recovering a user's wallet."
---
...
![IMAGE: MPC Wallet Generation](../.gitbook/assets/1. MPC Wallet Generation - dark.png)
...
![IMAGE: MPC Backup Mechanism Setup](../.gitbook/assets/2. MPC Backup Mechanism Setup - dark.png)
...
![IMAGE: MPC Recovery](../.gitbook/assets/MPC Recovery - dark.png)
