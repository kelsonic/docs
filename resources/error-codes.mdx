---
title: "Error Codes"
description: "This guide documents the error identifiers returned by Portal's MPC (Multi-Party Computation) operations."
---
...
* [Portal Status Page](https://status.portalhq.io)
