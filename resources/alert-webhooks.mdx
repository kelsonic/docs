...
2.  Navigate to `"Settings"` > `"Alert Webhooks"` in the [Portal Admin Dashboard](https://app.portalhq.io) and click `"New +"`.
    ![IMAGE: Click "New +" in the "Alert Webhooks" section.](../.gitbook/assets/alert_webhooks_new (1).png)
3.  Enter your alert webhook URL:

    ![IMAGE: Enter your alert webhook URL.](../.gitbook/assets/image.png)
...
| `X-WEBHOOK-SECRET` | String | You can find the alert webhook secret in the [Portal Admin Dashboard](https://app.portalhq.io) on the `"Settings"` page under the `"Alert Webhooks"` section. |
