...
description: "This guide will walk you through the two different credentials you need to work with Portal."
---
...
![IMAGE: Create a new Portal API Key.](../.gitbook/assets/image (8).png)
...
![IMAGE: Create a new Client API Key.](../.gitbook/assets/image (7).png)
...
![IMAGE: Create a new Client Session Token.](../.gitbook/assets/image (5).png)
