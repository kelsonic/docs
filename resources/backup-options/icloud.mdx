...
2.  Navigate to `Signing & Capabilities`:
    ...
    ![IMAGE: Signing & Capabilities](https://user-images.githubusercontent.com/165256/187792977-8e2b4388-f276-40ea-a835-3cf05183b8d9.png)
3.  Click the `+` Button right below it, scroll down and select `iCloud`.

    ![IMAGE: iCloud](https://user-images.githubusercontent.com/165256/187793954-e94496b8-0b7f-47c7-9117-92c31bf79c67.png)
4. Under iCloud Services select `Key-value storage`.

    ![IMAGE: Key-value storage](../../.gitbook/assets/Screen Shot 2022-11-09 at 8.05.20 PM.png)
