...
description: "This guide will walk you through the process of configuring Account Abstraction for your organization and your users."
---
...
![IMAGE: Modify Account Abstraction configuration in the Portal Admin Dashboard.](../.gitbook/assets/image (45).png)
...
![IMAGE: Click "Edit Policy" to modify the amount of gas sponsored per chain every month (30 days).](../.gitbook/assets/Screenshot 2024-12-03 at 6.01.38 AM.png)
...
![IMAGE: Specify the amount of gas to sponsor for a chain every month (30 days).](../.gitbook/assets/Screenshot 2024-12-03 at 6.05.47 AM.png)
