---
title: "API Reference"
description: "These endpoints require a Portal API Key (aka 'Custodian API Key') as a bearer token."
---
...
<table><thead><tr><th>Name</th><th width="193">Type</th><th>Description</th></tr></thead><tbody><tr><td>Authorization*</td><td>String</td><td>Bearer <strong><code>&#x3C;Custodian API Key></code></strong></td></tr><tr><td>Content-Type*</td><td>String</td><td>application/json</td></tr></tbody></table>
...
| -------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `clientId`d;">\* | String | The ID of the client.                                                                                                                                            |
| `chainId`d;">\*  | String | Must be in [CAIP-2 format](https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md) or chain identifier shortcut (e.g. `eip155:11155111` or `sepolia`). |
...
<table><thead><tr><th>Name</th><th width="193">Type</th><th>Description</th></tr></thead><tbody><tr><td><code>alertWebhookId</code>d;">*</td><td>String</td><td>The <code>"id"</code> of the alert webhook. You can get this from the <a href="v3-endpoints.md#get-a-list-of-alert-webhooks">list alert webhooks endpoint</a>.</td></tr></tbody></table>

##### Body Parameters

<table><thead><tr><th>Name</th><th width="226">Type</th><th>Description</th></tr></thead><tbody><tr><td><code>eventIds</code>d;">*</td><td>String[]</td><td>A list of <code>"failed"</code> alert webhook event <code>"id"</code>s to replay.</td></tr></tbody></table>
...
<table><thead><tr><th>Name</th><th width="193">Type</th><th>Description</th></tr></thead><tbody><tr><td><code>chainId</code>d;">*</td><td><a href="../../resources/chain-id-formatting.md">CAIP-2 chain</a></td><td>The CAIP-2 chain ID. Be sure it is URL encoded.</td></tr></tbody></table>
