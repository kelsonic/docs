...
| Name                                        | Type                          | Description                                                                                                                                                      |
| ------------------------------------------- | ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `chainId` (Required) | String                        | Must be in [CAIP-2 format](https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md) or chain identifier shortcut (e.g. `eip155:11155111` or `sepolia`). |
...
| Name                                      | Type   | Description                                                                                                                                                      |
| ----------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `chain` (Required) | String | Must be in [CAIP-2 format](https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md) or chain identifier shortcut (e.g. `eip155:11155111` or `sepolia`). |
...
| Name                                        | Type   | Description                                                                                                              |
| ------------------------------------------- | ------ | ------------------------------------------------------------------------------------------------------------------------ |
| `chainId` (Required) | String | Must be in [CAIP-2 format](https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md) (e.g. `"eip155:11155111"`). |
...
| Name                                        | Type   | Description                                                                                                                                                       |
| ------------------------------------------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `chainId` (Required) | String | Must be in [CAIP-2 format](https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md) (e.g. `eip155:11155111`, `solana:EtWTRABZaYq6iMfeYKouRu166VU2xqa1`). |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>`gas`</td>
      <td>String</td>
      <td>The gas limit provided for the transaction.</td>
    </tr>
    <tr>
      <td>`gasPrice`</td>
      <td>String</td>
      <td>The price per unit of gas the sender is willing to pay.</td>
    </tr>
    <tr>
      <td>`maxFeePerGas`</td>
      <td>String</td>
      <td>The maximum total fee per gas unit the sender is willing to pay.</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>`value`</td>
      <td>String</td>
      <td>The amount of native token to send with the transaction.</td>
    </tr>
    <tr>
      <td>`data`</td>
      <td>String</td>
    ...
    <tr>
      <td>`operationType`</td>
      <td>
        <p>`"validation"`, `"simulation"`, or `"all"`</p>
        <p><br />Default: `"all"`</p>
      </td>
      <td>The operation to perform with the transaction.</td>
    </tr>
  </tbody>
</table>
</Tab>
...
| Name                                            | Type                                                                                                                     | Description                                         |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------- |
| `transactions` (Required)                       | String\[]                                                                                                                | An array of base58 encoded serialized transactions. |
| `operationType`                                 | <p>`"validation"`, `"simulation"`, or `"all"`</p><p><br />Default: `"all"`</p> | The operation to perform with the transaction.      |
</Tab>
</Tabs>
