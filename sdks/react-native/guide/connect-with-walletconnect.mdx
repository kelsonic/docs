...
description: "Portal Connect allows you to connect your Portal MPC Wallet to any dApp that supports WalletConnect without extra dependency bloat."
---
...
<Note>
This package does not negate the need to install other Portal dependencies, namely `@portal-hq/core`. Portal Connect depends on an existing `Portal` instance to operate properly.
</Note>
