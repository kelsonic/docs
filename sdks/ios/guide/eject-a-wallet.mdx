---
title: "Eject a wallet"
description: "The eject feature allows a user to construct private keys that can be imported into another wallet manager, such as MetaMask."
---
...
<Note>
The `walletId` can be found in the `wallets` property of the `/api/custodians/me/clients/\(clientId)` `GET` request.
</Note>
