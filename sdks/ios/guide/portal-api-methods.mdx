---
title: "Portal API methods"
description: "Portal API's convenient helper methods are designed to streamline data retrieval from the Portal REST API."
---
...
* [getBalances function reference](../../reference/ios/getbalances.md)
