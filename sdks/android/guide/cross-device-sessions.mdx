...
description: "This guide will walk you through how to use wallet provisioning to enable your users to create multiple signing shares across their devices."
---
