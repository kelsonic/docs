---
title: "Add custom signature hooks"
description: "This guide will help you configure custom signature hooks for requests to the Portal Provider to ensure your business logic is properly implemented into Portal's signing flow."
---
...
portal.provider.on("portal_signingRequested") { data: Any? ->
    ...
    val isLargeTransaction = checkIfLargeTransaction(request)
...
Now that you've implemented your custom signature hooks, let's dive into how to handle progress callbacks for your `portal.provider.on("portal_signingRequested")` function.
