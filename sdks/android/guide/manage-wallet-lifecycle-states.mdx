...
description: "This guide will walk you through how to manage your users' wallet lifecycle states."
---
...
suspend fun manageWalletState(portal: Portal) {
    try {
        ...
        val walletExists = portal.doesWalletExist()
        val walletExistsOnDevice = portal.isWalletOnDevice()
        val walletIsRecoverable = portal.isWalletRecoverable()
