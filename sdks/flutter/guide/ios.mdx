...
![IMAGE: Platform channels overview](../../.gitbook/assets/PlatformChannels.png)
...
2. Add `PortalSwift` to the iOS project, you can follow this [setup](../../sdks/ios/guide/setup.md).
