---
title: "Web authentication methods"
description: "The Portal Web SDK offers various approaches to authenticating. The main reason for this is to allow you to strike the right balance between integration time and security."
---
